...
// 1. Article Card Preview Component (No change)
const ArticleCard = React.memo(({ article, navigateToArticle }) => {
    ...
    return (
        // Added bg-[#FDF6F0] to color the card pink
        <div 
            className="article-preview-card p-6 bg-[#FDF6F0] shadow-xl rounded-3xl border border-gray-100 flex flex-col overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl"
...
// 2. Rolodex View Component (No change)
...
// 3. Full Article View Component (No change)
const ArticleView = ({ article, navigateToRolodex }) => {
    // Added bg-[#FDF6F0] to color the container pink
    return (
...
// 4. Admin Form Component (No change)
...
const App = () => {
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(q, (snapshot) => {
            ...
            // Firebase permission errors are often resolved by refreshing or ensuring rules are public.
            setLoading(false);
        });
